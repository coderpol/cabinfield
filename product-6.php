<?php 
// page title
$page_title="Product Customized - V5";
            ...
            <div class="col-md-12">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="pills-1">
                        <form action="#" class="cabinform">
                            <div class="accordion" id="customizations">
                                <?php include_once('sections/product-page/accordions/strain-sub-accordion.php') ?>
                            </div>
                            <div class="border-bottom mb-4"></div>
                            <?php include_once('sections/product-page/order-details-small.php') ?>
                        </form>
                    </div>
                    ...
                    <div class="tab-pane fade" id="pills-5" role="tabpanel" aria-labelledby="pills-5">
                        <?php include_once('sections/product-page/tabs/upholstery-sample.php') ?>
                    </div>
                </div>
            </div>
        </div>
