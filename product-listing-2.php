...
<div class="section page-content product-listing-section">
    <div class="container">
        ...
        <div class="row">
            <!-- filter area  -->
            <div class="col-md-3 page-sidebar accordion-area" id="filter-area" style="display: none;">
            ...
            <div class="col-lg-9 main-content product-listing-area col-lg-12" id="product-listing-area">
