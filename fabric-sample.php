...
<div class="section page-heading-section clearfix mb-5">
    <div class="container">
        <div class="row page-headline">
            <div class="col-md-12 col-12 section-title text-start">
...
<div class="section fabric-section display-board clearfix">
    <div class="container">
        <div class="row">
            <div class="col-md-12 mb-2 section-sub-title">
                <h3>Ordering your samples</h3>
            </div>
        </div>
...
<div class="section popular-fabric-area clearfix">
    <div class="container">
        <div class="row">
        ...
        <div class="row sample-area">
            ...
            <div class="col-md-3 col-12 sample">
                ...
                <div class="text">
                    <h4>Faux Leather</h4>
                    <p>Faux Leather is a more affordable option if you want the leather look. It is extremely durable, has a uniform color and texture, and is fade-resistant.</p>
                </div>
            </div>
        </div>
    </div>
