<div class="col-md-3 col-lg-3 page-sidebar accordion-area" id="filter-area" style="display:<?php if($visibility==0){echo "none";} ?>" >
    <form action="#" class="accordion accordion-flush cabinform filter-form" id="filters">
        ...
        <div class="filter-options">
            <h3 class="title">Wood Options:</h3>
            <ul>
                <li>Oak</li>
                <li>Brown Maple</li>
                <li>Quartersawn White Oak</li>
                <li>Cherry</li>
                <li>Sap Cherry</li>
                <li>Hickory</li>
                <li>Walnut</li>
                <li>Hard Maple</li>
                <li>Rustic Quartersawn White Oak</li>
                <li>Rustic Brown Maple</li>
                <li>Rustic Cherry</li>
                <li>Rustic Hickory</li>
                <li>Rustic Walnut</li>
                <li>Ambrosia Maple</li>
                <li>Elm (available upon request)</li>
            </ul>
        </div>
        
        <div class="filter-options">
            <h3 class="title">Finish Options:</h3>
            <ul>
                <li>Natural (clear finish, unstatined)</li>
                <li>Stain</li>
                <li>2 tone staining</li>
                <li>Paint</li>
                <li>Paint and stain</li>
                <li>Stain with glaze</li>
                <li>Stain with rub through</li>
                <li>Stain with burnish</li>
                <li>Stain with distressing</li>
                <li>Paint with glaze</li>
                <li>Paint with rub through</li>
                <li>Paint with burnish</li>
                <li>Paint with distressing</li>
                <li>Paint and stain with glaze</li>
                <li>Paint and stain with rub through</li>
                <li>Paint and stain with burnish</li>
                <li>Paint and stain with distressing</li>
            </ul>
        </div>
        
        <div class="filter-options">
            <h3 class="title">Bed Size Options:</h3>
            <ul>
                <li>Twin</li>
                <li>Full</li>
                <li>Queen</li>
