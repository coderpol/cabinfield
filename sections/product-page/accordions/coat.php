<div class="accordion-item">
    <div class="accordion-header" id="headingFifth">
        <h4 class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFifth" aria-expanded="true" aria-controls="collapseFifth">Coat rack on footboard:  <span class="blue">Wooden pegs on right  + 85,</span> <span class="blue">Wooden pegs  + 85</span> <span data-bs-toggle="modal" data-bs-target="#edit_zip"><i class="fa-solid fa-circle-question"></i></span></h4>
    </div>
