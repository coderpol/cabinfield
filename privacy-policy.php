            ...
            <section class="col-md-9 main-content mb-5">
                ...
                <article class="sub-article">
                    <header class="article-title uppercase">
                        <h4>POLICIes AND PRACTICES TO PROTECT CONFIDENTIAL INFORMATION</h4>
                    </header>  
                    <p>At Cabinfield, we limit the availability of personally identifiable data about our customers only to employees who have a true business need for the information. Additionally, Cabinfield maintains the highest standards of physical, electronic and procedural safeguards that comply with applicable local laws to protect the personal information of our customers. Such safeguards include, but are not limited to, the use of firewalls for our web-based systems, encryption technologies, user authentication systems and mechanisms to ensure access control. We go out of our way to prevent credit card fraud and we are committed to protecting our customers as much as possible.</p>
                    <p>Use of Cookies: Cookies are minuscule data files that may be placed on the hard drive of a user upon visiting a website. These files enable the website to identify repeat visitors and may allow the website to customize the website depending on the preferences of the user. Cookies will not affect the performance of your computer.</p>
                    <p>Cabinfield may, from time to time or on a continuous basis, use cookies when users enter our website. The use of cookies allows Cabinfield to identify the user, observe which sections of the website are visited, and gain insight into the areas of the website are most frequently used. This allows Cabinfield to tailor the website to individual tastes and preferences of our customers. The cookies used in the protected areas of the site will reside on the user's computer.</p>
                    <p>We may use cookies to keep track of our returning customers. Cookies are alphanumeric identifiers that we transfer to your computer's hard drive through your Web browser to store items in your Shopping Cart between visits.</p>
