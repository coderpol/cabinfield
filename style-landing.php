    ...
    <div class="container">
        <div class="row page-headline">
            <div class="col-md-8 col-12 section-title">
                <h1><span>Mission</span> Bedroom Styles</h1>
            </div>
        ...
        <div class="row heading-text">
            <div class="col-md-12">
                <h2 class="head">Mission Bedroom Furtniture Collections</h2>
        ...
        <div class="row">
            ...
            <div class="col-md-9 faq-area">
                ...
                <ol>
                    ...
                    <li><strong>Decide on the number of people you will seat</strong><p>Are you looking for a standalone bench set, or a bench to set beside the table? Take into account the number of people you will seat at the table. Don’t forget to leave space to maneuver around the bench! No one likes to be asked to stand up so that someone can get past.</p></li>
                </ol>
