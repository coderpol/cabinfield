...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans&family=Playfair+Display&display=swap" rel="stylesheet"> 
    <link rel="stylesheet" href="css/gift-certificate.css">
</head>
<body>
    <div class="giftpage">
                ...
                <div class="container clearfix">
                    ...
                    <div class="gift_fields">
                        ...
                        <div class="clearfix field full_field">
                            <p><span class="label w186">Personal Message:</span><span class="value">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi eaque.</span></p>
                        </div>
                    </div>
